...
class Customer(models.Model):
    ...
    def __str__(self): return f"{self.customer_id} - {self.name}"
...
class VehicleType(models.Model):
    ...
    def __str__(self): return f"{self.vehicletype_id} - {self.category}"
...
class Vehicle(models.Model):
    ...
    def __str__(self): return f"{self.vehicle_id} - {self.make} {self.model}"
...
class Reservation(models.Model):
    ...
    def __str__(self): return f"{self.reservation_id}"
...
class Rental(models.Model):
    ...
    def __str__(self): return f"{self.rental_id}"
...
class Payment(models.Model):
    ...
    def __str__(self): return f"{self.payment_id}"
...
class Maintenance(models.Model):
    ...
    def __str__(self): return f"{self.maintenance_id}"
...
class InsurancePolicy(models.Model):
    ...
    vehicle = models.ForeignKey(Vehicle, on_delete=models.PROTECT)
    def __str__(self): return f"{self.insurance_id} - {self.policy_number}"
